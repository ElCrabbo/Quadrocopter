...
int main(int argc, char* args[])
{
    ...
    */
    Eigen::VectorXf initial_state(6);
    ...
    */
    extern std::vector<float> x_history;
    extern std::vector<float> y_history;
    extern std::vector<float> theta_history;
        ...
        while (!quit)
        {
            ...
            while (SDL_PollEvent(&e) != 0)
            {
                ...
                else if (e.type == SDL_KEYDOWN)
                {
                    ...
                    {
                        auto l_1 = matplot::subplot(1, 3, 3);
                        matplot::plot(x_history);
                        matplot::title("Plot 1");
                        matplot::xlabel("time");
                        matplot::ylabel("X");

                        auto l_2 = matplot::subplot(1, 3, 1);
                        matplot::plot(y_history);
                        matplot::title("Plot 2");
                        matplot::xlabel("time");
                        matplot::ylabel("Y");

                        auto l_3 = matplot::subplot(1, 3, 2);
                        matplot::plot(theta_history);
                        matplot::title("Plot 3");
                        matplot::xlabel("time");
